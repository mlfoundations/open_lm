...
def create_grid_plot(base_dir_1, base_dir_2, key_text, epoch_num=2, ratio=0.1, name_suffix="", output_dir=""):
    ...
    if output_dir != "" and output_dir[-1] != "/":
        output_dir += "/"
    plt.savefig(f'{output_dir}text_pretraining_datacompdronly_vs_vision_text{text_evals[key_list_text]}_grid_epoch{epoch_num}_ratio{ratio}{name_suffix}.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def create_single_plot(base_dir_1, base_dir_2, key_text, key_vision, epoch_num=2, ratio=0.1, name_suffix="", output_dir=""):
    ...
    if output_dir[-1] != "/":
        output_dir += "/"
    plt.savefig(f'{output_dir}text_pretraining_datacompdronly_vs_vision{vision_evals[key_list_vision]}_text{text_evals[key_list_text]}_single_epoch{epoch_num}_ratio{ratio}{name_suffix}.png', dpi=300, bbox_inches='tight')
    plt.show()
