...
def create_grid_plot(base_dir_1, base_dir_2, key_text, epoch_num=2, bucket=5, name_suffix="", output_dir=""):
    ...
    if output_dir != "" and output_dir[-1] != "/":
        output_dir += "/"
    plt.savefig(f'{output_dir}pretraining_image_ratio_datacompdronly_vs_vision_text{text_evals[key_list_text]}_grid_epoch{epoch_num}_bucket{bucket}{name_suffix}.png', dpi=300, bbox_inches='tight')
    plt.show()
