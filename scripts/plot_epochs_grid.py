...
def create_grid_plot(base_dir_1, base_dir_2, key_text, ratio=2, bucket=5, name_suffix="", output_dir=""):
    ...
    if output_dir[-1] != "/":
        output_dir += "/"
    plt.savefig(f'{output_dir}finetuning_epochs_vs_vision_text{text_evals[key_list_text]}_grid_ratio{ratio}_bucket{bucket}{name_suffix}.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def create_single_plot(base_dir_1, base_dir_2, key_text, key_vision, ratio=2, bucket=5, name_suffix="", output_dir=""):
    ...
    if output_dir[-1] != "/":
        output_dir += "/"
    plt.savefig(f'{output_dir}finetuning_epochs_vs_vision{vision_evals[key_vision]}_text{text_evals[key_text]}_ratio{ratio}_bucket{bucket}{name_suffix}.png', dpi=300, bbox_inches='tight')
    plt.show()
