...
Unit testing is an active area of development. We use `pytest` for testing. For testing support, first run `pip install pytest`.

To run tests, make sure your machine is GPU enabled. From the root directory run:
```
pytest tests/
```
