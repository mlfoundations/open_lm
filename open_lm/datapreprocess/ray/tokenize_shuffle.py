...
def get_raw_filetype(key: str):
    ...
    elif key.endswith(".jsonl.zst") or key.endswith(".json.zst") or key.endswith(".jsonl.zstd") or key.endswith(".json.zstd"):
...
def main(args):
    ...
    for inp_folder in input_folders:
        ...
        input_paths += glob_files(inp_folder, suffix=".zstd")
