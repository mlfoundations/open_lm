...
class Block(nn.Module):
    def __init__(self, layer_id, args: Params):
        ...
        if args.ffn_type == "swiglu":
            ...
            # Copied from mosaic-ml default init.
            torch.nn.init.kaiming_normal_(self._ff_w1.weight, a=0.0, mode="fan_in", nonlinearity="relu")
            torch.nn.init.kaiming_normal_(self._ff_w2.weight, a=0.0, mode="fan_in", nonlinearity="relu")
            torch.nn.init.zeros_(self._ff_w1.bias)
            torch.nn.init.zeros_(self._ff_w2.bias)
